...
function createSynthetiEvent(inter) {
  /**
   * 合成事件 的基类
   ...
   * @param {*} nativeEventTarget 原生事件源 对应的真实DOM
   */
  function SyntheticBaseEvent(
    ...
    this._nativeEventTarget = nativeEventTarget;
...
export const SyntheticMouseEvent = createSynthetiEvent(MouseEventInterface);
